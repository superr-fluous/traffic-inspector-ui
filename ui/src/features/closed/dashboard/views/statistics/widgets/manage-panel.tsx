...
export interface ManagePanelProps {
	...
	onChangeWidgetName: (id: Layout["i"], name: Layout["meta"]["name"]) => void;
	onToggleBookmark: (id: Layout["i"], bookmarked: Layout["meta"]["bookmarked"]) => void;
}

const ManagePanel: FC<ManagePanelProps> = ({
	open,
	widgets,
	onEnable,
	onAdd,
	...
	const changeWidgetName = (id: Layout["i"]) => {
	...
	const toggleBookmark = (id: Layout["i"], current: Layout["meta"]["bookmarked"]) => {
