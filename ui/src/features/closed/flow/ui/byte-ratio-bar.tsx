...
import { HELPERS_DATA_PRETTIFY_BYTES } from "@shared/helpers/data";
...
export const ByteRatioBar: FC<Props> = ({
  ...
  return (
    ...
    >
      <BlockHeader icon={DonutSmall} title="Byte Ratio" />
        ...
        >
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography variant="caption" color="text.secondary">
              {HELPERS_DATA_PRETTIFY_BYTES(source)}
            </Typography>
          </Box>
          ...
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography variant="caption" color="text.secondary">
              {HELPERS_DATA_PRETTIFY_BYTES(total)}
            </Typography>
          </Box>
          ...
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography variant="caption" color="text.secondary">
              {HELPERS_DATA_PRETTIFY_BYTES(destination)}
            </Typography>
          </Box>
        </Box>
      </div>
