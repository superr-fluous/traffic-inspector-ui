...
const Toolbar: FC<Props> = ({ addMode, deleteMode, onCancel, onDelete, onSelectWidgetSize }) => {
	...
	return (
		<div className={styles.toolbar}>
			{!addMode && (
				<>
					<Button ref={menuAnchor} startIcon={<AddIcon />} disabled={deleteMode} onClick={() => setShowSizeMenu(true)}>
						Add widget
					</Button>
					<Menu
						open={showSizeMenu}
